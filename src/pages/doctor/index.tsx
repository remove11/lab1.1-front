...
const Doctor: React.FC = () => {
    ...
    let [patients, setPatient] = useState<IDoctor[]|null>(null)
    ...
    <main>
        <div className="max-w-[1300px] min-h-[400px] border rounded-3xl m-auto">
            <div className='border-b flex justify-between items-center'>
                ...
                <Link to="/app/create-doctor">
                    <div className='mr-9'>
                        <button className='px-6 py-3 rounded-full bg-[#3260FC] text-white'>New Doctor</button>
                    </div>
                </Link>
            </div>
